...
@section('title', 'Services Clone - Glorya Beauty')
...
@endpush
@section('description', 'Explore our premium beauty services (Clone) including skincare, nail art, makeup, and hair treatments')
                            ...
                            <div class="breadcrumb-wrap text-left">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Services Clone</li>
                                    </ol>
                                </nav>
                            </div>
                                </div>
                     ...
                     <div class="row">
                         <div class="col-lg-12">
                             <div class="section-title center-align mb-50 text-center">
                                 <h2>Our Premium Beauty Services (Clone)</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/rg.jpg') }}" style="height:350px;" alt="Regular / Basic Pedicure">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/rp.jpg') }}" style="height:350px;" alt="Raaga / Premium Pedicure">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/op.jpg') }}" style="height:350px;" alt="O3+ Pedicure">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h5>O3+ Pedicure</h5>
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/ro.png') }}" style="height:350px;" alt="Roll in Waxing">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/sp.jpg') }}" style="height:350px;" alt="Spatula Waxing">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/bi.jpg') }}" style="height:350px;" alt="Rica Brazilian Stripless Bikini Waxing">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/fa.jpg') }}" style="height:350px;" alt="Rica Brazilian Stripless Bikini Waxing">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/fl.jpg') }}" style="height:350px;" alt="Full Leg Waxing">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/fs.jpg') }}" style="height:350px;" alt="Full Body Waxing">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                 <img src="{{ asset('images/services/hle.jpg') }}" style="height:350px;" alt="Full Body Waxing">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                             <img src="{{ asset('images/services/bkw.jpg') }}" style="height:350px;" alt="Full Body Waxing">    
                                            <div class="service-header">
                                                    <h6>Bikini Waxing</h6>
                                                    <div class="price-info">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                 <img src="{{ asset('images/services/ard.jpg') }}" style="height:350px;" alt="Full Body Waxing">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                 <img src="{{ asset('images/services/sto.jpg') }}" style="height:350px;" alt="Full Body Waxing">
                                                <div class="service-header">
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/kf.jpg') }}" style="height:350px;" alt="Korean Glass Skin Facial">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/ar.jpg') }}" style="height:350px;" alt="Aroma Magic Instant Glow Facial">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/o3f.jpg') }}" style="height:350px;" alt="O3+ Shine & Glow Facial">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/arf.jpg') }}" style="height:350px;" alt="Sara Lightening Glow Facial">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/yf.jpg') }}" style="height:350px;" alt="O3+ Feel Youthful Facial">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/bp.jpg') }}" style="height:350px;" alt="O3+ Feel Youthful Facial">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/wf.jpg') }}" style="height:350px;" alt="O3+ Feel Youthful Facial">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/krf.jpg') }}" style="height:350px;" alt="O3+ Feel Youthful Facial">
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/kff.jpg') }}" style="height:350px;" alt="O3+ Bridal Facial Kit">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/ju.jpg') }}" style="height:350px;" alt="O3+ Professional Whitening Facial Kit">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/srf.jpg') }}" style="height:350px;" alt="Sara Gold Facial Kit">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/dif.jpg') }}" style="height:350px;" alt="Pakdee Diamond Glass Shine Facial Kit">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/gh.jpg') }}" style="height:350px;" alt="Sara Hydra Aqua Bomb Facial Kit">
                                                <div class="service-header">
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/cleanup.jpeg') }}" style="height:250px;" alt="Sara Fruit Cleanup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/sk.jpeg') }}" style="height:250px;" alt="O3+ Tan Clear Cleanup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/pin.jpg') }}" style="height:250px;" alt="03 professional seaweed cleanup">
                                                <div class="service-header">
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/fleg.jpg') }}" style="height:350px;" alt="Full Legs Bleach">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h6>Full Legs</h6>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/fbl.jpg') }}" style="height:350px;" alt="Full Body Bleach">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h6>Full Body</h6>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/abl.jpg') }}" style="height:350px;" alt="Full Arms Bleach">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h6>Full Arms</h6>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/cbl.jpg') }}" style="height:350px;" alt="Chest Bleach">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h6>Chest</h6>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/fnb.jpg') }}" style="height:350px;" alt="Face & Neck Bleach">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h6>Face & Neck</h6>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/bbl.jpg') }}" style="height:350px;" alt="Back Bleach">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h6>Back</h6>
...
Price - ₹449	
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/Manicure.jpeg') }}" alt="One-Side Open Style">
...
Time - 45 Min									
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/regular.jpeg') }}" alt="Open Half-Tie Style">
...
Time - 45 Min									
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/reg1.jpeg') }}" alt="Hair Straightening">
...
Time - 45 Min									
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/cleanup.jpeg') }}" alt="Curls & Waves">
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-30">
                                            <div class="service-card detailed">
                                                <img src="{{ asset('images/services/sb.jpg') }}" style="height:350px;" alt="Straight & Smooth Blow Dry">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 mb-30">
                                            <div class="service-card detailed">
                                                <img src="{{ asset('images/services/co.jpg') }}" style="height:350px;" alt="In Curl / Out Curl Blow Dry">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                    ...
                    <div class="service-cards-grid mb-60">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 mb-30">
                                <div class="service-card">
                                    <div class="service-image" style="object-fit:inherit;height:350px;">
                                        <img src="{{ asset('images/services/ponytail.jpeg') }}" alt="Ponytail / Braid">
                            ...
                            <div class="col-lg-4 col-md-6 mb-30">
                                <div class="service-card">
                                    <div class="service-image" style="object-fit:inherit;height:350px;">
                                        <img src="{{ asset('images/services/oneside-open.jpeg') }}" alt="One-Side Open Style">
                            ...
                            <div class="col-lg-4 col-md-6 mb-30">
                                <div class="service-card">
                                    <div class="service-image" style="object-fit:inherit;height:350px;">
                                        <img src="{{ asset('images/services/half-tie.jpeg') }}" alt="Open Half-Tie Style">
                            ...
                            <div class="col-lg-4 col-md-6 mb-30">
                                <div class="service-card">
                                    <div class="service-image" style="object-fit:inherit;height:350px;">
                                        <img src="{{ asset('images/services/straightening.jpeg') }}" alt="Hair Straightening">
                                        <div class="service-overlay">
                            ...
                            <div class="col-lg-4 col-md-6 mb-30">
                                <div class="service-card">
                                    <div class="service-image" style="object-fit:inherit;height:350px;">
                                        <img src="{{ asset('images/services/curls-waves.jpeg') }}" alt="Curls & Waves">
                                        <div class="service-overlay">
                                            <span class="service-price-tag">₹549</span>
                                            <span class="discount-tag">25% OFF</span>
                                        </div>
                      ...
                      <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/basic.jpeg') }}" style="height:350px;" alt="Basic Makeup Package">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/hd.jpg') }}" style="height:350px;" alt="HD Makeup Package">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/lux.jpeg') }}" style="height:350px;" alt="Luxe Makeup Package">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/combo.jpg') }}" style="height:350px;" alt="Premium Makeup Combo">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/bs.jpg')}}" style="height:350px;" alt="Basic Bridal Makeup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/br.jpg') }}" style="height:350px;" alt="Premium Bridal Makeup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/pk.jpg') }}" style="height:350px;" alt="Basic Party Makeup">
                                                <div class="service-header">
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/er.jpg')}}" style="height:350px;" alt="Basic Makeup (Light/Everyday)">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/mat.jpg') }}" style="height:350px;" alt="HD Finish Makeup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/lu.jpg') }}" style="height:350px;" alt="Luxe Glam-up Makeup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/bha.jpg') }}" style="height:350px;" alt="Basic Hairstyling">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/ahr.jpg') }}" style="height:350px;" alt="Advanced Hairstyling">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/bsd.jpg') }}" style="height:350px;" alt="Basic Saree Draping">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card mini">
                                                <img src="{{ asset('images/services/dd.jpg') }}" style="height:350px;" alt="Advanced Saree/Dupatta Draping">
                                                <div class="service-header">
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/be.jpg') }}" style="height:350px;" alt="Basic Eye Makeup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/se.jpg') }}" style="height:350px;" alt="Soft Glam Eye Makeup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/sme.jpg') }}" style="height:350px;" alt="Smoky Eye Makeup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/ce.jpg') }}" style="height:350px;" alt="Cut Crease Eye Makeup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/eg.jpg') }}" style="height:350px;" alt="Glitter Shimmer Eye Glam">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/bey.jpg') }}" style="height:350px;" alt="Bridal Eye Makeup">
                                                <div class="service-header">
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/pt.jpg') }}" style="height:350px;" alt="Party Makeup">
                                                <div class="service-header">
                                                    <h5>Party Makeup</h5>
                                                    <div class="price-info">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/hl.jpg') }}" style="height:350px;" alt="Haldi Ceremony Makeup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/rc.jpg') }}" style="height:350px;" alt="Reception Makeup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/bm.jpg') }}" style="height:350px;" alt="HD Bridal Makeup">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/el.jpg') }}" style="height:350px;" alt="Eyelash Extension">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/nu.jpg') }}" style="height:350px;" alt="HD Nude Makeup">
                                                <div class="service-header">
                    ...
                    <div class="service-cards-grid mb-60">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/basic.jpeg') }}">
                                            </div>
                                            <div class="service-content">
                                                <h4>Basics Makeup</h4>
                                                <div class="pricing-info">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/haldi.jpeg') }}" alt="One-Side Open Style">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/lux.jpeg') }}" alt="Open Half-Tie Style">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/smoky.jpeg') }}" alt="Hair Straightening">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/nude_mack.jpeg') }}" alt="Curls & Waves">
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/plain.jpg') }}" style="height:250px;" alt="Plain Gel Polish">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h5>Plain</h5>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/matte.jpg') }}" style="height:250px;" alt="Matte Gel Polish">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h5>Matte</h5>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/solid.jpg') }}" style="height:250px;" alt="Solid Multi Color">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/frenchcl.jpg') }}" style="height:250px;" alt="Classic French">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h5>Classic</h5>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/vshape.jpg') }}" style="height:250px;" alt="V Shaped French">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h5>V Shaped</h5>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/glitter.jpg') }}" style="height:250px;" alt="Glitter French">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h5>Glitter</h5>
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/cla.jpeg') }}" style="height:250px;" alt="Classic Ombre">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h5>Classic ombre</h5>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/glitter.jpg') }}" style="height:250px;" alt="Vertical Ombre">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/FrenchGlitter.jpeg') }}" style="height:250px;" alt="Glitter Ombre">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h5>Glitter ombre</h5>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/marble.jpeg') }}" style="height:250px;" alt="Classic Marble">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/gal.jpg') }}" style="height:250px;" alt="Galaxy Marble">
                                                <div class="service-header">
                                                    <h5>Galaxy marble</h5>
                                                    <div class="price-info">
                                                        <span class="original-price">₹1,499</span>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/marn.jpg') }}" style="height:350px;" alt="Marbled Gold">
                                                <div class="service-header">
                                                    <h5>Marbled gold</h5>
                                                    <div class="price-info">
                                                        <span class="original-price">₹1,499</span>
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/crome.jpg') }}" style="height:250px;" alt="Classic Chrome">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h5>Classic</h5>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/gal.jpg') }}" style="height:250px;" alt="Holographic Nails">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h5>Holographic</h5>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/line.jpg') }}" style="height:250px;" alt="Chrome Lines">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h5>Chrome Lines</h5>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/fr.jpg') }}" style="height:250px;" alt="Chrome French Tips">
                                                <div class="service-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div>
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                         <img src="{{ asset('images/services/cat.jpg') }}" style="height:250px;" alt="Curls & Waves">
                                                <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                             <img src="{{ asset('images/services/ab.jpg') }}" style="height:250px;" alt="Curls & Waves">    
                                            <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/gal.jpg') }}" style="height:250px;" alt="Curls & Waves">    
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                        <img src="{{ asset('images/services/line.jpg') }}" style="height:250px;" alt="Curls & Waves">       
                                            <div class="service-header">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <div class="service-header">
                                                    <img src="{{ asset('images/services/mul.jpg') }}" style="height:250px;" alt="Curls & Waves">
                            ...
                            <div class="col-lg-12">
                                <div class="service-subcategory mb-40">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/solid.jpg') }}" style="height:250px;"  alt="Curls & Waves">
                                                <div class="service-header">
                                                    <h5>Solid Colours</h5>
                                                    <div class="price-info">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/fr.jpg') }}"  style="height:250px;"  alt="Curls & Waves">
                                                <div class="service-header">
                                                    <h5>French Nails</h5>
                                                    <div class="price-info">
                                                        <span class="original-price">₹625</span>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                <img src="{{ asset('images/services/nart.jpg') }}"  style="height:250px;"  alt="Curls & Waves">
                                                <div class="service-header">
                                                    <h5>Nail Art</h5>
                                                    <div class="price-info">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-30">
                                            <div class="service-card">
                                                ...
                                                <img src="{{ asset('images/services/crome.jpg') }}" style="height:250px;" alt="Curls & Waves">
                                                <div class="service-header">
                                                    <h5>Chrome Nails</h5>
                                                    <div class="price-info">
                                                        <span class="original-price">₹875</span>
                            ...
                            <div class="service-cards-grid mb-60">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/plain.jpeg') }}">
                                            </div>
                                            <div class="service-content">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/FrenchGlitter.jpeg') }}" alt="French Glitter Nails">
                                            </div>
                                            <div class="service-content">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/cla.jpeg') }}" alt="Open Half-Tie Style">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/french.jpeg') }}" alt="Hair Straightening">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="service-card">
                                            <div class="service-image" style="object-fit:inherit;height:350px;">
                                                <img src="{{ asset('images/services/Solidgel.jpeg') }}" alt="Solid Multi Color Gel Polish">
