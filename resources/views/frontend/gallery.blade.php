...
@section('title', 'Gallery - Glorya Beauty')
@section('description', 'Browse our gallery of beautiful transformations and stunning beauty work by Glorya Beauty experts')
            ...
            <section id="work" class="pt-100 pb-70">
                ...
                <div class="grid col3">
				   	<div class="grid-item seo">                        	
                            <div class="case-study-box">
                              <div class="case-study-img">
                                   <img src="{{ asset('images/services/makeup.jpg') }}" alt="Makeup Services">
                                </div>
					...
					<div class="grid-item marketing">
                      <div class="case-study-box">
                              <div class="case-study-img">
                                   <img src="{{ asset('images/services/hair-style.jpg') }}" alt="Hair Styling">
                                </div>
                               <div class="case-study-content">
                     ...
                     <div class="grid-item smm">
                       <div class="case-study-box">
                              <div class="case-study-img">
                                   <img src="{{ asset('images/services/skin.jpg') }}" alt="Skin Care">
                                </div>
                               <div class="case-study-content">
                     ...
                     <div class="grid-item website">
                        <div class="case-study-box">
                              <div class="case-study-img">
                                   <img src="{{ asset('images/services/nail.jpg') }}" alt="Nail Services">
                                </div>
                               <div class="case-study-content">
                     ...
                     <div class="grid-item website">
                        <div class="case-study-box">
                              <div class="case-study-img">
                                   <img src="{{ asset('images/services/Manicure.jpeg') }}" alt="Manicure">
                                </div>
                               <div class="case-study-content">
                     ...
                     <div class="grid-item website">
                        <div class="case-study-box">
                              <div class="case-study-img">
                                   <img src="{{ asset('images/services/FrenchGlitter.jpeg') }}" alt="French Nails">
                                </div>
                               <div class="case-study-content">
                    ...
                    <div class="grid-item website">
                        <div class="case-study-box mb-30">
                              <div class="case-study-img">
                                   <img src="{{ asset('images/services/marble.jpeg') }}" alt="Marble Nails">
                                </div>
                               <div class="case-study-content">
                    ...
                    <div class="grid-item smm">
                      <div class="case-study-box">
                              <div class="case-study-img">
                                   <img src="{{ asset('images/services/bleach.jpeg') }}" alt="Bleach Service">
                                </div>
                               <div class="case-study-content">
                     ...
                     <div class="grid-item smm">
                        <div class="case-study-box">
                              <div class="case-study-img">
                                   <img src="{{ asset('images/services/wax.jpeg') }}" alt="Waxing Service">
                                </div>
                               <div class="case-study-content">
