...
@section('title', 'Blog Details - Glorya Beauty')
@section('description', 'Read detailed beauty tips and trends from Glorya Beauty experts')

@section('content')
<!-- main-area -->
<main>
    <!-- page-title-area -->
    <section class="page-title-area" style="background-image:url({{ asset('images/bg/quote_bg.png') }})">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-8">
                    <div class="blog-details-content">
                        <div class="blog-details-thumb">
                            <img src="{{ asset('images/blog/blog_img01.png') }}" alt="Blog Post">
                        </div>
                        ...
                        <div class="sidebar-widget recent-post-widget">
                            ...
                            <div class="recent-post">
                                <div class="recent-post-thumb">
                                    <img src="{{ asset('images/blog/blog_img02.jpg') }}" alt="Recent Post">
                                </div>
                                <div class="recent-post-content">
                                    <h5><a href="{{ url('/blog-details') }}">Wedding Makeup Tips</a></h5>
                                    <span>10 April, 2024</span>
                                </div>
                            </div>
                            <div class="recent-post">
                                <div class="recent-post-thumb">
                                    <img src="{{ asset('images/blog/blog_img03.jpeg') }}" alt="Recent Post">
                                </div>
                                <div class="recent-post-content">
                                    <h5><a href="{{ url('/blog-details') }}">Hair Style Designs</a></h5>
