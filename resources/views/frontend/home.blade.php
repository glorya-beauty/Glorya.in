...
@section('title', 'Glorya Beauty')
@section('description', 'Luxury salon care at home, empowering service professionals')
...
<main>
    ...
    <section id="home" class="slider-area slider-four fix p-relative">
        <div class="slider-active">
            <div class="single-slider slider-bg d-flex align-items-center" style="background: url({{ asset('images/slider/slider_img_bg.png') }}) no-repeat;">
                <div class="container">
                    <div class="row justify-content-center pt-50">
                        ...
                        <div class="col-lg-6">
                            <div class="slider-img" data-animation="fadeInUp" data-delay=".4s">
                                <img src="{{ asset('images/slider/slider_img05.png') }}" alt="slider_img05">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 col-sm-12 pr-30">
                    <div class="s-about-img p-relative  wow fadeInLeft  animated" data-animation="fadeInLeft" data-delay=".4s">
                        <img src="{{ asset('images/features/about_img.png') }}" alt="img">    
                    </div>
                </div>
    ...
    <!-- services-area -->          
    <section id="services" class="services-area pt-100 pb-70 fix" style=" background-image: url({{ asset('images/bg/proved-bg.png') }}); background-size: cover; background-repeat: no-repeat; background-color: #fff5f4;" >
        <div class="container">
            <div class="row">   
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    <div class="services-box text-center wow fadeInUp  animated" data-delay=".4s">
                        <div class="services-icon">
                            <img src="{{ asset('images/icon/pv-icon1.png') }}" alt="icon01">
                        </div>
                        <div class="services-content2">
                            <h5><a href="{{ url('/services') }}">Expert Beauty Artists</a> <span class="line5"> <img src="{{ asset('images/bg/bx-line.png') }}" alt="circle_left"></span></h5>   
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="services-box text-center wow fadeInDown  animated" data-delay=".5s">
                        <div class="services-icon">
                            <img src="{{ asset('images/icon/pv-icon2.png') }}" alt="icon01">
                        </div>
                        <div class="services-content2">
                            <h5><a href="{{ url('/services') }}">Happy Clients Served</a> <span class="line5"> <img src="{{ asset('images/bg/bx-line.png') }}" alt="circle_left"></span></h5>   
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="services-box text-center wow fadeInUp  animated" data-delay=".4s">
                        <div class="services-icon">
                            <img src="{{ asset('images/icon/pv-icon3.png') }}" alt="icon01">
                        </div>
                        <div class="services-content2">
                            <h5><a href="{{ url('/services') }}">Premium Beauty Products</a> <span class="line5"> <img src="{{ asset('images/bg/bx-line.png') }}" alt="circle_left"></span></h5>   
        ...
        <div class="container">
            ...
            <div class="service-cards-grid mb-60">
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-30">
                        <div class="service-image-card">
                            <div class="card-img">
                                <img src="{{ asset('images/services/skin.jpg') }}" alt="Skin Care" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6 mb-30">
                        <div class="service-image-card">
                            <div class="card-img">
                                <img src="{{ asset('images/services/hair-style.jpg') }}" alt="Hair Styling" class="img-fluid">
                                <div class="card-overlay">
                                    <div class="overlay-content">
                                        <h4>Hair Styling</h4>
                    ...
                    <div class="col-lg-3 col-md-6 mb-30">
                        <div class="service-image-card">
                            <div class="card-img">
                                <img src="{{ asset('images/services/makeup.jpg') }}" alt="Makeup Services" class="img-fluid">
                                <div class="card-overlay">
                                    <div class="overlay-content">
                                        <h4>Makeup</h4>
                    ...
                    <div class="col-lg-3 col-md-6 mb-30">
                        <div class="service-image-card">
                            <div class="card-img">
                                <img src="{{ asset('images/services/nail.jpg') }}" alt="Nail Art" class="img-fluid">
                                <div class="card-overlay">
                                    <div class="overlay-content">
                                        <h4>Nail Art</h4>
            ...
            <div class="text-center mt-60">
                <a href="{{ url('/services') }}" class="btn ss-btn">View All Services</a>
            </div>
        </div>
    </section>
    <!-- glorya-services-end -->
                    ...
                    <div class="row">
                           ...
                           <div class="pricing-box pricing-box2 text-center mb-60  wow fadeInLeft  animated">
                                <div class="pricing-head">       
                                    <div class="icon mb-30">
                                        <img src="{{ asset('images/icon/pr-icon1.png') }}" alt="circle_right">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                           <div class="pricing-box pricing-box2 text-center mb-60  wow fadeInDown  animated">
                                <div class="pricing-head">       
                                    <div class="icon mb-30">
                                        <img src="{{ asset('images/icon/pr-icon2.png') }}" alt="circle_right">
                                    </div>
                                    <h2>VIP Member</h2>   
                                    <hr>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                           <div class="pricing-box pricing-box2 text-center mb-60  wow fadeInRight  animated">
                                <div class="pricing-head">       
                                    <div class="icon mb-30">
                                        <img src="{{ asset('images/icon/pr-icon3.png') }}" alt="circle_right">
                                    </div>
    ...
    <section id="price" class="price-packages-section" style="background-color: #F0D196; background-size: cover; background-repeat: no-repeat; background-position: center center; background-attachment: fixed;">
            ...
            <div class="row g-md-5 my-0">
                <div class="col-md-6 my-4">
                    <div class="bg-white p-2 p-lg-5 rounded-3 shadow-lg">
                        <div class="list-group rounded-0">
                            <a href="{{ url('/services') }}" class="border-0 list-group-item list-group-item-action d-lg-flex align-items-center gap-4 py-3" aria-current="true">
                                <img src="{{ asset('images/services/marble.jpeg') }}" alt="Custom Nail Art Design" width="100" height="100" class="rounded-circle flex-shrink-0 mb-4">
                            ...
                            <a href="{{ url('/services') }}" class="border-0 list-group-item list-group-item-action d-lg-flex align-items-center gap-4 py-3" aria-current="true">
                                <img src="{{ asset('images/services/Manicure.jpeg') }}" alt="Manicure + Pedicure" width="100" height="100" class="rounded-circle flex-shrink-0 mb-4">
                                <div style="padding:15px;">
                                    <div class="d-flex gap-4 w-100 justify-content-between">
                            ...
                            <a href="{{ url('/services') }}" class="border-0 list-group-item list-group-item-action d-lg-flex align-items-center gap-4 py-3" aria-current="true">
                                <img src="{{ asset('images/services/makeup.jpg') }}" alt="Bridal Eye Makeup" width="100" height="100" class="rounded-circle flex-shrink-0 mb-4">
                                <div style="padding:15px;">
                                    <div class="d-flex gap-4 w-100 justify-content-between">
                            ...
                            <a href="{{ url('/services') }}" class="border-0 list-group-item list-group-item-action d-lg-flex align-items-center gap-4 py-3" aria-current="true">
                                <img src="{{ asset('images/services/party.jpeg') }}" alt="Party Makeup + Hair Styling" width="100" height="100" class="rounded-circle flex-shrink-0 mb-4">
                                <div style="padding:15px;">
                                    <div class="d-flex gap-4 w-100 justify-content-between">
                ...
                <div class="col-md-6 my-4">
                    <div class="bg-white p-2 p-md-5 rounded-3 shadow-lg">
                        <div class="list-group rounded-0">
                            <a href="{{ url('/services') }}" class="border-0 list-group-item list-group-item-action d-lg-flex align-items-center gap-4 py-3" aria-current="true">
                                <img src="{{ asset('images/services/skin.jpg') }}" alt="Korean Glass Skin Facial" width="100" height="100" class="rounded-circle flex-shrink-0 mb-4">
                                <div style="padding:15px;">
                                    <div class="d-flex gap-4 w-100 justify-content-between">
                            ...
                            <a href="{{ url('/services') }}" class="border-0 list-group-item list-group-item-action d-lg-flex align-items-center gap-4 py-3" aria-current="true">
                                <img src="{{ asset('images/services/wax.jpeg') }}" alt="Full Body Waxing + Facial" width="100" height="100" class="rounded-circle flex-shrink-0 mb-4">
                                <div style="padding:15px;">
                                    <div class="d-flex gap-4 w-100 justify-content-between">
                            ...
                            <a href="{{ url('/services') }}" class="border-0 list-group-item list-group-item-action d-lg-flex align-items-center gap-4 py-3" aria-current="true">
                                <img src="{{ asset('images/services/Solidgel.jpeg') }}" alt="Gel Manicure + Pedicure" width="100" height="100" class="rounded-circle flex-shrink-0 mb-4">
                                <div style="padding:15px;">
                                    <div class="d-flex gap-4 w-100 justify-content-between">
                            ...
                            <a href="{{ url('/services') }}" class="border-0 list-group-item list-group-item-action d-lg-flex align-items-center gap-4 py-3" aria-current="true">
                                <img src="{{ asset('images/services/haldi.jpeg') }}" alt="Bridal Makeup + Hair Styling + Saree Draping" width="100" height="100" class="rounded-circle flex-shrink-0 mb-4">
                                <div style="padding:15px;">
                                    <div class="d-flex gap-4 w-100 justify-content-between">
       ...
       <!-- contact-area -->
					...
					<div class="col-lg-6 col-md-12 col-sm-12">
                         ...
                         <div class="col-lg-6 col-md-12 col-sm-12 pr-30">
                            <div class="s-about-img p-relative wow fadeInDown  animated">
                                <img src="{{ asset('images/bg/client-img01.png') }}" alt="img">   
            ...
            <section class="testimonial-area pt-100 pb-100 p-relative fix" style="background-color: #fff5f4;">
                 <div class="test-an-01"><img src="{{ asset('images/bg/test-an-01.png') }}" alt="test-an-01"></div>
                <div class="test-an-02"><img src="{{ asset('images/bg/test-an-02.png') }}" alt="test-an-02"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title center-align mb-50 text-center">
                        ...
                        <div class="col-lg-12">
                            <div class="testimonial-active2">
                                <div class="single-testimonial text-center">
                                    ...
                                    <img src="{{ asset('images/testimonial/qt-icon.png') }}" alt="img">
                                    </div>
                                    <p class=" wow fadeInUp  animated">Glorya has transformed my beauty routine completely! Their skin care treatments are absolutely amazing, and the nail art services are always on point. The staff is incredibly professional and makes you feel pampered from the moment you walk in. I've been a loyal client for months and couldn't be happier with the results!</p>
                                     <div class="test-line">
                                          <img src="{{ asset('images/bg/test-line.png') }}" alt="test-line"> 
                                    </div>
                                    <div class="testi-author">
                                        <img src="{{ asset('images/testimonial/testi_avatar.png') }}" alt="img">
                                        <div class="ta-info">
                                            <h6>Priya Sharma</h6>
                        ...
                        <div class="col-lg-12">
                            <div class="section-title center-align mb-50 text-center">
                               ...
                               Latest Blog & News
                                ...
                                <span class="line3"> <img src="{{ asset('images/bg/circle_left.png') }}" alt="circle_left"></span>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="single-post2 mb-30  wow fadeInDown  animated">
                                <div class="blog-thumb2">
                                    <a href="{{ url('/blog-details') }}"><img src="{{ asset('images/blog/blog_img01.png') }}" alt="img"></a>
                                ...
                                <div class="blog-content2">     
                                    <div class="b-meta">
                                     ...
                                     <div class="row">
                                        <div class="col-lg-12">
                                         <h4><a href="{{ url('/blog-details') }}">Top 5 Skincare Trends for Spring 2026</a></h4>    
                                        </div>
                                    </div>
                                      <div class="b-meta">
                                       <div class="row align-items-center">
                                             ...
                                             <div class="adim-box">
                                            <div class="c-icon"><img src="{{ asset('images/blog/ad.png') }}" alt="c-Icon.png" style="height:40px;"></div>
                                        <div class="text">  
                                           Glorya Team
                                        </div>
                                        </div>
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                               <div class="blog-btn"><a href="{{ url('/blog') }}">Read More</a></div>
                                             </div>
                                         </div>
                                    </div>
                         ...
                         <div class="col-lg-4 col-md-12">
                            <div class="single-post2 mb-30  wow fadeInUp  animated">
                                <div class="blog-thumb2">
                                    <a href="{{ url('/blog-details') }}"><img src="{{ asset('images/blog/blog_img02.jpg') }}" alt="img"></a>
                                ...
                                <div class="blog-content2">     
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                         <h4><a href="{{ url('/blog-details') }}">Wedding Makeup Tips for the Modern Bride</a></h4>    
                                        </div>
                                    </div>
                         ...
                         <div class="col-lg-4 col-md-12">
                            <div class="single-post2 mb-30 wow fadeInDown  animated">
                                <div class="blog-thumb2">
                                    <a href="{{ url('/blog-details') }}"><img src="{{ asset('images/blog/blog_img03.jpeg') }}" alt="img"></a>
                                ...
                                <div class="blog-content2">     
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                         <h4><a href="{{ url('/blog-details') }}">Hair style Designs That Are Trending Now</a></h4>    
                                        </div>
                                    </div>
                                      <div class="b-meta">
                                       <div class="row align-items-center">
