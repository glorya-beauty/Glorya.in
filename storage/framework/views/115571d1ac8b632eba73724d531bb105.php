                ...
                <div class="container">
					...
					<div class="row align-items-center">
						<div class="col-lg-6">
							...
							<form action="<?php echo e(route('contact.submit')); ?>" method="post" class="contact-form" id="contact-form">
							<?php echo csrf_field(); ?>
							<div class="row">
                            <div class="col-lg-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Glorya/resources/views/frontend/contact.blade.php ENDPATH**/ ?>