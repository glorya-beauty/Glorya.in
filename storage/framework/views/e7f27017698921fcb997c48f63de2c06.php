<?php $__env->startSection('title', 'Book Service - Glorya Beauty'); ?>
<?php $__env->startSection('description', 'Book your beauty service appointment at Glorya Beauty'); ?>
        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="contact-bg02 wow fadeInLeft animated">
                    ...
                    <form action="<?php echo e(route('booking.store')); ?>" method="POST" enctype="multipart/form-data" class="contact-form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <!-- Service Selection -->
                            <div class="col-lg-12">
                                    ...
                                    <select name="service_name" id="service_name" required>
                                        ...
                                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $categoryServices): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <optgroup label="<?php echo e(ucfirst($category)); ?>">
                                                <?php $__currentLoopData = $categoryServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceName => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($serviceName); ?>" data-price="<?php echo e($price); ?>">
                                                        <?php echo e($serviceName); ?> - <?php echo e($price); ?>/-</option>
                                    ...
                                    <select name="booking_time" id="booking_time" required>
                                        ...
                                        <?php for($hour = 9; $hour <= 18; $hour++): ?>
                                            <?php for($minute = 0; $minute < 60; $minute += 60): ?>
                                                ...
                                                ?>
                                                <option value="<?php echo e($time); ?>"><?php echo e($displayTime); ?> - <?php echo e($displayEndTime); ?></option>
                                            <?php endfor; ?>
                                        <?php endfor; ?>
                                    </select>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Gloryabeauty\resources\views/frontend/booking/index.blade.php ENDPATH**/ ?>