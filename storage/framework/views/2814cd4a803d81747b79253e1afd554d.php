                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="contact-field p-relative c-name mb-20">
                                            ...
                                            <input type="text" id="customer_name" name="customer_name" value="<?php echo e(Auth::user()->name); ?>" placeholder="e.g., Priya Sharma" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="contact-field p-relative c-email mb-20">
                                            ...
                                            <input type="email" id="customer_email" name="customer_email" value="<?php echo e(Auth::user()->email); ?>" placeholder="e.g., user@example.com" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="contact-field p-relative c-phone mb-20">
                                            ...
                                            <input type="tel" id="customer_phone" name="customer_phone" value="<?php echo e(Auth::user()->phone ?? ''); ?>" placeholder="e.g., 9876543210" maxlength="10" required>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="contact-field p-relative c-message mb-20">
                                            ...
                                            <textarea id="address" name="address" rows="3" placeholder="e.g., 123 Main Road, Sector 15, Delhi - 110001" required><?php echo e(Auth::user()->address ?? ''); ?></textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="qr-code-display" style="background: white; padding: 30px; border-radius: 8px; border: 2px solid #007bff; margin: 20px 0;">
                                            ...
                                            <img id="payment-qr" src="<?php echo e(asset('images/QR.jpeg')); ?>" alt="Payment QR Code" class="img-fluid" style="max-width: 100%; height: auto; width: 300px;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Glorya.in\resources\views/frontend/booking/checkout.blade.php ENDPATH**/ ?>