                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($booking->payment_screenshot): ?>
                                                ...
                                                ?>
                                                <?php if($imageUrl && $imageUrl != asset('images/no-image.jpg')): ?>
                                                    <img src="<?php echo e($imageUrl); ?>" 
                                                         class="payment-screenshot-thumb" 
                                                         alt="Payment Screenshot" 
                                                         data-toggle="modal" 
                                                         data-target="#screenshotModal<?php echo e($booking->id); ?>"
                                                         title="Click to view payment screenshot"
                                                         onerror="this.src='<?php echo e(asset('images/no-image.jpg')); ?>'">
                                                <?php else: ?>
                                                    <div class="no-image-placeholder" data-toggle="modal" data-target="#screenshotModal<?php echo e($booking->id); ?>">
                                                        <i class="fas fa-image"></i>
                                                    </div>
                                                <?php endif; ?>
                                                <button type="button" class="btn btn-sm btn-info mt-1" data-toggle="modal" data-target="#screenshotModal<?php echo e($booking->id); ?>">
                                                    <i class="fas fa-image"></i> View
                                                </button>
                                            <?php else: ?>
                                                <span class="badge badge-unverified">No Screenshot</span>
                                            <?php endif; ?>
                                            <button type="button" class="btn btn-sm btn-primary mt-1" data-toggle="modal" data-target="#bookingModal<?php echo e($booking->id); ?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    ...
                                                    <?php
                                                        ...
                                                        $imageExists = ImageHelper::paymentScreenshotExists($booking->payment_screenshot);
                                                    ?>
                                                    <?php if($imageExists && $imageUrl != asset('images/no-image.jpg')): ?>
                                                        <img src="<?php echo e($imageUrl); ?>" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Glorya/resources/views/admin/bookings.blade.php ENDPATH**/ ?>