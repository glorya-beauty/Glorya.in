                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <?php if($booking->payment_screenshot): ?>
                                                ...
                                                <?php if($imageExists): ?>
                                                    <img src="<?php echo e($imageUrl); ?>" 
                                                         ...
                                                         data-bs-target="#screenshotModal<?php echo e($booking->id); ?>"
                                                ...
                                                <?php endif; ?>
                                                <button type="button" class="btn btn-sm btn-info mt-1" data-bs-toggle="modal" data-bs-target="#screenshotModal<?php echo e($booking->id); ?>">
                                                    <i class="fas fa-image"></i> View
                                                </button>
                                            <?php else: ?>
                                                <span class="badge badge-unverified">No Screenshot</span>
                                            <?php endif; ?>
                                            <button type="button" class="btn btn-sm btn-primary mt-1" data-bs-toggle="modal" data-bs-target="#bookingModal<?php echo e($booking->id); ?>">
                                    ...
                                    <?php if($booking->payment_screenshot): ?>
                                    <div class="modal fade" id="screenshotModal<?php echo e($booking->id); ?>" tabindex="-1">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Payment Screenshot - Booking #<?php echo e($booking->id); ?></h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                    </button>
                                                </div>
                                                <div class="modal-body text-center">
                                                    <div class="mb-3">
                                                        <h6>Customer: <?php echo e($booking->customer_name); ?></h6>
                                                        <p class="text-muted">Service: <?php echo e($booking->service_name); ?> | Amount: <?php echo e(number_format($booking->amount, 2)); ?></p>
                                                    </div>
                                                    <?php
                                                        $imageUrl = ImageHelper::getPaymentScreenshotUrl($booking->payment_screenshot);
                                                        $imageExists = ImageHelper::paymentScreenshotExists($booking->payment_screenshot);
                                                    ...
                                                    <?php if($imageExists): ?>
                                                        <div class="screenshot-container">
                                                            <img src="<?php echo e($imageUrl); ?>" 
                                                                 ...
                                                                 onerror="this.src='<?php echo e(asset('images/no-image.jpg')); ?>'; console.log('Image failed to load:', this.src);">
                                                            <div class="mt-3">
                                                                <small class="text-muted d-block mb-2">File: <?php echo e(basename($booking->payment_screenshot)); ?></small>
                                                    ...
                                                    <?php else: ?>
                                                        <div class="text-center p-4">
                                                            ...
                                                            <small class="text-muted">Expected file: <?php echo e(basename($booking->payment_screenshot)); ?></small>
                                                            <div class="mt-3">
                                                                <a href="<?php echo e(asset('uploads/payments')); ?>" 
                                                                   target="_blank" 
                                    ...
                                    <div class="modal fade" id="bookingModal<?php echo e($booking->id); ?>" tabindex="-1">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Booking Details #<?php echo e($booking->id); ?></h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="mb-3">
                                                                <p><strong>Name:</strong> <?php echo e($booking->customer_name); ?></p>
                                                                <p><strong>Email:</strong> <?php echo e($booking->customer_email); ?></p>
                                                                <p><strong>Phone:</strong> <?php echo e($booking->customer_phone); ?></p>
                                                                <p><strong>Address:</strong> <?php echo e($booking->customer_address ?: 'N/A'); ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <p><strong>Date:</strong> <?php echo e($booking->booking_date ? $booking->booking_date->format('M d, Y') : 'N/A'); ?></p>
                                                                <p><strong>Time:</strong> <?php echo e($booking->time_slot); ?></p>
                                                                <p><strong>Amount:</strong> <span style="color: #cf921c; font-weight: 700;">₹<?php echo e(number_format($booking->amount, 2)); ?></span></p>
                                                                <p><strong>Status:</strong> <span class="badge-status badge-<?php echo e($booking->status); ?>"><?php echo e(ucfirst($booking->status)); ?></span></p>
                                                                <p><strong>Payment Verified:</strong> <span class="badge-status badge-<?php echo e($booking->payment_verified ? 'verified' : 'unverified'); ?>"><?php echo e($booking->payment_verified ? 'Verified' : 'Not Verified'); ?></span></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <?php if($booking->payment_screenshot): ?>
                                                                ...
                                                                <div class="text-center">
                                                                    ...
                                                                    <?php if($imageExists): ?>
                                                                        <img src="<?php echo e($imageUrl); ?>" 
                                                                             ...
                                                                             alt="Payment Screenshot"
                                                                             onerror="this.src='<?php echo e(asset('images/no-image.jpg')); ?>'; console.log('Details modal image failed to load:', this.src);">
                                                                        <div class="mt-2">
                                                                            <small class="text-muted d-block mb-2">File: <?php echo e(basename($booking->payment_screenshot)); ?></small>
                                                                            <a href="<?php echo e($imageUrl); ?>" 
                                                                               target="_blank" 
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col-12">
                                                                ...
                                                                <div class="alert alert-info" style="border-radius: 10px; border-left: 4px solid #cf921c;">
                                                                    <i class="fas fa-sticky-note mr-2"></i> <?php echo e($booking->notes); ?>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <?php if($booking->payment_screenshot): ?>
                                                        ...
                                                        ?>
                                                        <?php if($imageExists): ?>
                                                            <a href="<?php echo e($imageUrl); ?>" target="_blank" class="btn btn-info">
    ...
    document.addEventListener('show.bs.modal', function (e) {
        ...
        if (img) {
            ...
            img.addEventListener('error', function() {
                ...
                this.src = '<?php echo e(asset("images/no-image.jpg")); ?>';
            }, { once: true });
        }
    });
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Gloryabeauty\resources\views/admin/bookings.blade.php ENDPATH**/ ?>