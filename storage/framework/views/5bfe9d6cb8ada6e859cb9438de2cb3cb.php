...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f4;">
    <div style="background-color: #fff; padding: 30px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        ...
        <p>Dear <?php echo e($booking->customer_name); ?>,</p>
        ...
        <div style="margin: 20px 0;">
            ...
            <div style="margin: 10px 0; display: flex; justify-content: space-between;">
                ...
                <span style="color: #333;"><strong><?php echo e($booking->booking_number); ?></strong></span>
            </div>
            <div style="margin: 10px 0; display: flex; justify-content: space-between;">
                <span style="font-weight: bold; color: #555;">Status:</span>
                <span style="color: #333;"><span style="background-color: #28a745; color: white; padding: 5px 10px; border-radius: 15px; font-size: 12px; font-weight: bold;"><?php echo e(ucfirst(str_replace('_', ' ', $booking->status))); ?></span></span>
            </div>
            <div style="margin: 10px 0; display: flex; justify-content: space-between;">
                <span style="font-weight: bold; color: #555;">Booking Date:</span>
                <span style="color: #333;"><?php echo e(\Carbon\Carbon::parse($booking->booking_date)->format('d M Y')); ?></span>
            </div>
            <div style="margin: 10px 0; display: flex; justify-content: space-between;">
                <span style="font-weight: bold; color: #555;">Time Slot:</span>
                <span style="color: #333;"><?php echo e($booking->time_slot); ?></span>
            </div>
        </div>
        ...
        <div style="margin: 20px 0;">
            ...
            <div style="margin: 10px 0; display: flex; justify-content: space-between;">
                ...
                <span style="color: #333;"><?php echo e($booking->customer_name); ?></span>
            </div>
            <div style="margin: 10px 0; display: flex; justify-content: space-between;">
                <span style="font-weight: bold; color: #555;">Email:</span>
                <span style="color: #333;"><?php echo e($booking->customer_email); ?></span>
            </div>
            <div style="margin: 10px 0; display: flex; justify-content: space-between;">
                <span style="font-weight: bold; color: #555;">Phone:</span>
                <span style="color: #333;"><?php echo e($booking->customer_phone); ?></span>
            </div>
            <div style="margin: 10px 0; display: flex; justify-content: space-between;">
                <span style="font-weight: bold; color: #555;">Address:</span>
                <span style="color: #333;"><?php echo e($booking->customer_address); ?></span>
            </div>
        </div>

        <?php if($booking->items && $booking->items->count() > 0): ?>
        <div style="margin: 20px 0;">
            ...
            <div style="background-color: #f9f9f9; padding: 15px; margin: 10px 0; border-radius: 5px; border-left: 4px solid #ff69b4;">
                <div style="margin: 5px 0; display: flex; justify-content: space-between;">
                    ...
                    <span style="color: #333;"><?php echo e($item->service_name); ?></span>
                </div>
                <div style="margin: 5px 0; display: flex; justify-content: space-between;">
                    <span style="font-weight: bold; color: #555;">Category:</span>
                    <span style="color: #333;"><?php echo e($item->service_category); ?></span>
                </div>
                <div style="margin: 5px 0; display: flex; justify-content: space-between;">
                    <span style="font-weight: bold; color: #555;">Duration:</span>
                    <span style="color: #333;"><?php echo e($item->service_time); ?></span>
                </div>
                <div style="margin: 5px 0; display: flex; justify-content: space-between;">
                    <span style="font-weight: bold; color: #555;">Price:</span>
                    <span style="color: #333;">₹<?php echo e(number_format($item->service_price, 2)); ?></span>
                </div>
                <div style="margin: 5px 0; display: flex; justify-content: space-between;">
                    <span style="font-weight: bold; color: #555;">Quantity:</span>
                    <span style="color: #333;"><?php echo e($item->quantity); ?></span>
                </div>
            </div>
        ...
        <div style="margin: 20px 0;">
            ...
            <div style="background-color: #f9f9f9; padding: 15px; margin: 10px 0; border-radius: 5px; border-left: 4px solid #ff69b4;">
                <div style="margin: 5px 0; display: flex; justify-content: space-between;">
                    <span style="font-weight: bold; color: #555;">Service:</span>
                    <span style="color: #333;"><?php echo e($booking->service_name); ?></span>
                </div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div style="background-color: #ff69b4; color: white; padding: 15px; border-radius: 5px; margin: 20px 0;">
            ...
            <div style="margin: 5px 0; display: flex; justify-content: space-between;">
                ...
                <span>₹<?php echo e(number_format($booking->base_amount ?? 0, 2)); ?></span>
            </div>
            <?php if($booking->gst_amount): ?>
            <div style="margin: 5px 0; display: flex; justify-content: space-between;">
                <span>GST (5%):</span>
                <span>₹<?php echo e(number_format($booking->gst_amount, 2)); ?></span>
            </div>
            <?php endif; ?>
            <div style="margin: 15px 0 5px 0; display: flex; justify-content: space-between; font-size: 18px; font-weight: bold; border-top: 1px solid rgba(255,255,255,0.3); padding-top: 10px;">
                ...
                <span>₹<?php echo e(number_format($booking->amount, 2)); ?></span>
            </div>
        </div>

        <div style="text-align: center; margin: 30px 0;">
            <a href="<?php echo e(route('my.bookings')); ?>" style="display: inline-block; padding: 12px 25px; background-color: #ff69b4; color: white; text-decoration: none; border-radius: 5px;">View My Bookings</a>
        </div>
...
<?php /**PATH C:\xampp\htdocs\Glorya.in\resources\views/emails/booking-confirmation.blade.php ENDPATH**/ ?>